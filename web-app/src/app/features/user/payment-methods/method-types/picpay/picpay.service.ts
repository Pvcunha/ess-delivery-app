...
export class PicpayService {
  ...
  //     user/pay
  create(id:string, method: PaymentMethod): Promise<PaymentMethod> {
    
    return this.http.post(this.taURL + "/user/" + id +"/methods", JSON.stringify(method), {headers: this.headers})
      .toPromise()
